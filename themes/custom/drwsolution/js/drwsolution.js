(function ($) {
   ...
   */
  Drupal.theme.prototype.drwsolutionExampleButton = function (path, title) {
   ...
   */
  Drupal.behaviors.drwsolutionBehavior = {
    attach: function (context, settings) {
      ...
      $('.some-selector', context).once('foo', function () {
        ...
        var $anchor = Drupal.theme('drwsolutionExampleButton', settings.myExampleLinkPath, settings.myExampleLinkTitle);
